...
def get_args():
    ...
    parser.add_argument("--model_path",type=str,default="./0.6/latest.pth")
    ...
    parser.add_argument('--lowest_utility', type=float, default=70.0) # 0.2:35, 0.6:70
...
#             w_loss = worker.train_mask(batch_size=args.batch_size, train_times=args.train_times)
#             buffer_mask.reset()
#
#
