...
def get_args():
    ...
    parser.add_argument("--model_path",type=str,default="./pretrain/latest.pth")
...
def main():
    ...
    worker = Worker(buffer=buffer, buffer_price=buffer_price, buffer_mask=buffer_mask, lr=args.lr, gamma=args.gamma, eps_clip=args.eps_clip, max_step=args.max_step,
                    ...
                    intelligent_worker=intelligent_worker, probability_worker = probability_worker, bilstm = args.bilstm, dropout = args.dropout, pretrain = True)
